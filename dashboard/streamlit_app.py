...
from simulation.yusuf_model import YusufConfig, YusufSystem, CapitalistSystem, ScenarioComparator
...
with open("/mnt/agents/output/yusuf-grondona-system/dashboard/streamlit_app.py", "w") as f:
    f.write(streamlit_app)

print("dashboard/streamlit_app.py créé")